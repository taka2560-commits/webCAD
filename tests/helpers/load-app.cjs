...
const APP_SCRIPTS = ['cad-errors.js', 'cad-text-parse.js', 'cad-dimension.js', 'cad-io.js', 'cad-core.js',
    ...
    'cad-survey.js', 'cad-cogo.js', 'cad-cogo-ui.js', 'cad-sdr.js', 'cad-ts.js', 'cad-stake.js', 'cad-print.js', 'cad-underlay.js', 'cad-photo.js', 'cad-editgeom.js', 'cad-edit.js', 'cad-grip.js', 'cad-storage.js', 'cad-guide.js', 'cad-boot.js'];
