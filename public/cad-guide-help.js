...
const GUIDE_TOPICS = [
    ...
    { id: 'prefs', cat: 'setting', title: '表示の設定（ルーペ・文字・吸着）', tour: 'prefs', keys: 'ひょうじ せってい るーぺ もじ おおきさ けた きゅうちゃく 表示 設定 文字 桁 吸着',
        steps: ['オプションの「表示・操作」で、ルーペの大きさ・倍率、座標の文字の大きさ・桁・単位、寸法の文字と桁、長さの単位、吸着の範囲を変えられます（端末ごと）。'],
        tips: ['単位（m・mm）の詳しい説明は「表示の単位（m・mm）」を見てください。'] },
    { id: 'units', cat: 'setting', title: '表示の単位（m・mm）', keys: 'たんい めーとる みりめーとる みり m mm 単位 メートル ミリ 座標 長さ 寸法 換算',
        ...
        tips: ['単位を選ぶと、入力欄の見出しに (mm) のように単位が付きます。', '記入した寸法（基点測定の寸法も）は、単位を変えるとすぐ描き直します。文字を書き換えた寸法はそのままです。', '測量計算・杭打ち・SIMA・座標一覧は、これまでどおり m です。'],
    ...
    { id: 'options', cat: 'setting', title: 'オプション（背景色・単位・系番号など）', keys: 'おぷしょん せってい はいけい たんい けいばんごう えらーろぐ 背景 単位 系番号 エラーログ',
        steps: [
            '背景色（黒・グレー・白）。',
            '表示・操作: ルーペ・座標の文字と桁と単位・寸法の文字と桁・長さの単位（m／mm）・吸着の範囲。',
