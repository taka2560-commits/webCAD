...
const GUIDE_COMMANDS = [
    ...
    ['COORDS', 'ZAHYO', '座標一覧'], ['COGO', 'CALC', '測量計算'], ['AREA', 'AA', '求積'], ['INV', '-', '逆計算'], ['TS', 'SOKKIA', 'TS連携'], ['SDROUT', '-', 'SDR33出力'], ['STAKE', 'KUI', '杭打ち'], ['PRINT', 'PDF', '印刷・PDF'], ['MAP', 'SHITAE', '地図・下絵'], ['SIMAOUT', '-', 'SIMA出力'], ['CSVOUT', '-', '座標CSV出力'], ['GNSS', 'GPS', '現在地'], ['UCS', '-', 'UCS（原点）'], ['UCS2P', '-', 'UCS（2点）'],
